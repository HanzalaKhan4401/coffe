...
if(isset($_POST['login'])){
  ...
  $verify = "SELECT * FROM `admin-signup` WHERE email = '$login_email'";
  
  $connection_login = mysqli_query($connection, $verify);
  if(mysqli_num_rows($connection_login) > 0){
    $row = mysqli_fetch_assoc($connection_login);
				...
				<h3 class="mb-4 billing-heading">Login</h3>
	              ...
	              <div class="col-md-12">
	                <div class="form-group">
	                    ...
	                    <input type="password" name="log_pass" class="form-control" placeholder="Password">
	                </div>
